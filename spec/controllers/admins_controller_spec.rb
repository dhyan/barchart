  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin as @admin" do
        ...
        post :create, {:admin => { "name" => "invalid value" }}, valid_session
        expect(assigns(:admin)).to be_a_new(Admin)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested admin" do
        ...
        expect_any_instance_of(Admin).to receive(:update).with({ "name" => "MyString" })
        put :update, {:id => admin.to_param, :admin => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the admin as @admin" do
        ...
        put :update, {:id => admin.to_param, :admin => { "name" => "invalid value" }}, valid_session
        expect(assigns(:admin)).to eq(admin)
      end
